...
// the same reason slack, waterfall, and the Cargo database do. Several skills
...
// declaring it twice in one project would collide the moment two skills were installed
// together.
//
...
// skills which never touch LinkedIn search should not inherit.
