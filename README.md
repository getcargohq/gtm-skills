...
| [`crm-enrichment`](crm-enrichment/SKILL.md)                | CRM accounts and contacts stay filled: approved blanks from LinkedIn, freshness after a real write, customer champions watched for job changes. |
