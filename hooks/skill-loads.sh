...
SKILL_NAMES="account-scoring agentic-engagement apollo-to-cargo build-tam-list call-capture clay-to-cargo crm-enrichment enrich-company-data enrich-linkedin-profile find-b2b-leads find-companies-using-tech find-linkedin-url find-portfolio-companies find-stakeholders find-work-email monitor-buying-signals research-account score-leads standup tam-building track-funding-rounds track-job-changes verify-email-list waterfall-enrichment weekly-planning zoominfo-to-cargo"
# END SKILL LIST
