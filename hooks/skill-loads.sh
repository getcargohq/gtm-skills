...
SKILL_NAMES="build-tam-list clay-to-cargo enrich-company-data enrich-linkedin-profile find-b2b-leads find-companies-using-tech find-linkedin-url find-portfolio-companies find-stakeholders find-work-email research-account score-leads track-funding-rounds track-job-changes verify-email-list"
# END SKILL LIST
