...
SKILL_NAMES="account-scoring apollo-to-cargo build-tam-list clay-to-cargo crm-dedup crm-enrichment enrich-company-data enrich-linkedin-profile find-b2b-leads find-companies-using-tech find-linkedin-url find-portfolio-companies find-stakeholders find-work-email monitor-buying-signals research-account score-leads tam-building track-funding-rounds track-job-changes verify-email-list waterfall-enrichment zoominfo-to-cargo"
# END SKILL LIST
