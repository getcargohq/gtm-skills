...
- Bundles what the other skills built — the research tool and agent,
...
Adds 1 resource (`defineMcpServer`) and requires the `research-agent` skill
...
None of its own — it carries `research-agent`'s and the shared connectors' (context
