...
- `infra/` holds one file per resource: the two connectors, the CRM account model, and the play that
  carries the row workflow. No file declares a resource that belongs to another.
