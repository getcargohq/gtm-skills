...
version: "0.6.4"
compatibility: "Requires the cargo-cdk skill, a Cargo CDK project, and @cargo-ai/cdk 1.0.73 or later — connectors bind the workspace default with `default: true`, which 1.0.72 and older do not understand. The repository example does not deploy or access a CRM until an agent adapts it in the consumer project."
