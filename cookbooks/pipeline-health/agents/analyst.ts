...
export const pipelineAnalyst = defineAgent("pipeline-analyst", {
  ...
  systemPrompt: [
    ...
    "",
    "5. ICP MISALIGNMENT. The account is off-profile on size, industry, or use case. If the account carries a score or tier from the account-scoring cookbook, reuse it rather than re-deriving fit.",
